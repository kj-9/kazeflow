...
Define how the core executor consumes inspectable plans, returns ordered run results,
emits passive events, and preserves dependency and partition semantics.
